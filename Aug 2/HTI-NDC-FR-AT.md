...
* l'accès aux différents mécanismes de marchés comme la Réduction des Emissions dues à la Déforestation et à la Dégradation (REDD+) et le Mécanisme pour un Développement Propre (MDP) ; 
