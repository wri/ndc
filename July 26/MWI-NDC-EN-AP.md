...
|  | Increase number of passengers using mass transport by 30% |  | x | x | x |
...
|  | Support an expanded programme of constructing multipurpose dams to enhance water storage |  | x | x | x |
